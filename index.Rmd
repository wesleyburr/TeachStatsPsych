...
* teach any menu-driven system (e.g., SPSS, Stata)
    ...
    - if using these, force scripting
...
When working computationally, you **should**:
...
* is actually how researchers work: no baby software or apps
...
* very large introductory statistics classes for science majors
...
* students are able (by the end of first semester) to create professional R Markdown
knit documents, with fully worked analyses of scientific data 
   - load data files
...
* I'm a statistician, and work with software every day of my professional life
* However ...
...
* I want to encourage you all to consider trying to integrate RStudio and R Markdown
into your courses
* Make sure you do it in a way which is actually modern (not 10 years out of date) - students
can tell
* It has to be integrated and seamless - a bolt-on will never work
* Leverage the "big data movement" to bring examples beyond the scope of the course
into the classroom to inspire and excite the students
* Always be learning!
